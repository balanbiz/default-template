...
let path = {
    ...
    src: {
        ...
        img_no_crop: source_folder + "/img/**/_*.{jpg,png,gif,ico,webp}",
...
let build = gulp.series(clean, gulp.parallel(js, css, html, html_no_min, images, copy_video, copy_svg, icons, images_no_crop, fonts), fontsStyle);
